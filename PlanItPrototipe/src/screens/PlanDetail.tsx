...
export default function PlanDetail() {
  ...
  const [confirmed, setConfirmed] = useState(searchParams.get("confirmed") === "1" || isCreator);
    ...
    <div className="min-h-screen bg-background pb-[120px]">
      ...
      <main className="pt-[64px] px-6 max-w-[800px] mx-auto">
        ...
        <section className="mt-4 relative rounded-2xl overflow-hidden shadow-lg aspect-[16/9]">
          <img src={HERO} alt="Asado en lo de Juan" className="w-full h-full object-cover" />
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/30 p-6 rounded-xl shadow-[0_4px_12px_rgba(74,93,63,0.04)]">
              ...
              <p className="text-[17px] text-on-surface-variant leading-relaxed mb-6">
                Che, ¡sale asado! Juan se puso la 10 y ya tiene todo listo. Traigan algo para tomar
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-surface-container-low p-5 rounded-xl">
              ...
              <div className="flex flex-col gap-4">
                {attendees.map(({ src, name }) => {
                  ...
                  const showConfirmed = !isCreator || isHost;
                  return (
                    <div key={name} className="flex items-center justify-between">
                      ...
                      {showConfirmed ? (
                        ...
                        <span className="text-[12px] font-semibold text-on-surface-variant bg-surface-container px-2.5 py-1 rounded-full">
                          Pendiente
                        </span>
                      )}
                    </div>
            ...
            {isCreator ? (
              <div className="bg-secondary-container p-5 rounded-xl">
                <div className="flex items-center gap-3 mb-1">
                  <span className="material-symbols-outlined text-primary text-[22px]" style={{ fontVariationSettings: "'FILL' 1" }}>
                    star
                  </span>
                  <h4 className="text-[18px] font-extrabold text-primary">Sos el anfitrión</h4>
                </div>
                <p className="text-[13px] text-on-surface-variant">
                  Creaste este plan. El grupo te confirma asistencia.
                </p>
              </div>
            ) : !confirmed ? (
